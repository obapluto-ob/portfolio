          ...
          <div className="bg-slate-800/30 rounded-lg p-8 border border-slate-700">
            ...
            <div className="space-y-4">
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => analytics.trackClick('contact_github', 'contact')}
                className="flex items-center space-x-3 p-4 border border-slate-600 hover:border-slate-500 hover:bg-slate-800 rounded-lg transition-all"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => analytics.trackClick('contact_linkedin', 'contact')}
                className="flex items-center space-x-3 p-4 border border-slate-600 hover:border-slate-500 hover:bg-slate-800 rounded-lg transition-all"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              ...
              <a 
                href="https://wa.me/254729237059?text=Hi%20Obed,%20I%20found%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20project"
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => analytics.trackClick('contact_whatsapp', 'contact')}
              ...
              <a 
                href="sms:+254729237059?body=Hi%20Obed,%20I%20found%20your%20portfolio%20and%20would%20like%20to%20discuss%20a%20project"
                onClick={() => analytics.trackClick('contact_sms', 'contact')}
                className="flex items-center space-x-3 p-4 border border-slate-600 hover:border-slate-500 hover:bg-slate-800 rounded-lg transition-all"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
